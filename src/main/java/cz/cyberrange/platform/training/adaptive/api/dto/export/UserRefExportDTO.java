package cz.cyberrange.platform.training.adaptive.api.dto.export;
 ...
 */
@ApiModel(
        value = "UserRefExportDTO",
        description = "An exported information about user reference."
)
public class UserRefExportDTO {
    ...
    @ApiModelProperty(value = "Reference to user in another microservice and get his iss", example = "https://oidc.com")
    private String iss;
