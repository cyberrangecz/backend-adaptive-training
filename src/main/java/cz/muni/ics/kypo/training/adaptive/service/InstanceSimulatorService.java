        ...
        events.keySet().forEach(phaseId -> {
            ...
            if (overallPhaseStatistics != null) {
                ...
                overallPhaseStatistics.setWrongAnswers(phaseEvents.stream()
                        ...
                        .filter(type -> Objects.equals(type, "cz.muni.csirt.kypo.events.adaptive.trainings.WrongAnswerSubmitted"))
                        .collect(Collectors.toList()));
                overallPhaseStatistics.setSolutionDisplayed(phaseEvents.stream()
                        .anyMatch(event -> Objects.equals(event.getType(), "cz.muni.csirt.kypo.events.adaptive.trainings.SolutionDisplayed")));
            }
