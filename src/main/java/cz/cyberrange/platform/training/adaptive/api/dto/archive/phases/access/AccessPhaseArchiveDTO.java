package cz.cyberrange.platform.training.adaptive.api.dto.archive.phases.access;
 ...
 */
@ApiModel(
        value = "AccessPhaseArchiveDTO",
        description = "Archived access phase.",
        parent = AbstractPhaseArchiveDTO.class
)
public class AccessPhaseArchiveDTO extends AbstractPhaseArchiveDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccessPhaseArchiveDTO)) return false;
        AccessPhaseArchiveDTO that = (AccessPhaseArchiveDTO) o;
