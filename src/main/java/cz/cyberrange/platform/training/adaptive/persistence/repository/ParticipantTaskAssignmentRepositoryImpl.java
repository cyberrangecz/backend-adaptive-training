...
import cz.cyberrange.platform.training.adaptive.domain.QParticipantTaskAssignment;
import cz.cyberrange.platform.training.adaptive.domain.phase.QAbstractPhase;
import cz.cyberrange.platform.training.adaptive.domain.phase.QTask;
import cz.cyberrange.platform.training.adaptive.domain.phase.QTrainingPhase;
