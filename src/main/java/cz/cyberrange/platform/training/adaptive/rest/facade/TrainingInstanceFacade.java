...
import cz.cyberrange.platform.training.adaptive.api.dto.traininginstance.TrainingInstanceAssignPoolIdDTO;
import cz.cyberrange.platform.training.adaptive.api.dto.traininginstance.TrainingInstanceBasicInfoDTO;
...
import cz.cyberrange.platform.training.adaptive.api.dto.traininginstance.TrainingInstanceFindAllResponseDTO;
import cz.cyberrange.platform.training.adaptive.api.dto.traininginstance.TrainingInstanceIsFinishedInfoDTO;
...
import cz.cyberrange.platform.training.adaptive.api.mapping.TrainingInstanceMapper;
...
public class TrainingInstanceFacade {
    ...
    private void deleteBashCommandsByPool(Long poolId) {
        try {
            elasticsearchServiceApi.deleteCommandsByPool(poolId);
    ...
    private void deleteBashCommandsByAccessToken(String accessToken){
        try {
            elasticsearchServiceApi.deleteCommandsByAccessToken(accessToken);
        } catch (MicroserviceApiException ignored){ }
    }
