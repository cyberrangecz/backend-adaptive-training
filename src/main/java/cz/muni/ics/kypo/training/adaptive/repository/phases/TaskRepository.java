...
public interface TaskRepository extends JpaRepository<Task, Long>, QuerydslPredicateExecutor<Task> {
    ...
    @Query("SELECT DISTINCT new cz.muni.ics.kypo.training.adaptive.dto.visualizations.sankey.NodeDTO(t.id, t.order, t.title, tp.id, tp.order, tp.title) FROM Task t " +
